...
<div class="containe-fluid">
	...
	$files = $conn->query("SELECT f.*,u.name as uname FROM files f inner join users u on u.id = f.user_id where  f.is_public = 1 order by date(f.updated_time) desc");
				...
				<div class="card-body">
					...
					?>
						<tr class='file-item' data-id="<?php echo $row['id'] ?>" data-name="<?php echo $name ?>">
							...
							<td><i><?php echo date('d/m/Y h:i A',strtotime($row['updated_time'])) ?></i></td>
